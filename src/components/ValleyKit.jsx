...
export default function ValleyKit() {
	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 relative overflow-hidden">
			...
			<motion.footer 
				className="relative bg-[#1e558e] text-white py-4 sm:py-4 mt-6 sm:mt-6 overflow-hidden"
				initial={{ opacity: 0, y: 50 }}
				whileInView={{ opacity: 1, y: 0 }}
				transition={{ duration: 0.8 }}
				viewport={{ once: true }}
			>
				{/* Subtle animated background for desktop */}
				...
				<div className="relative container mx-auto px-4 sm:px-6">
					{/* Mobile Layout: Ultra Compact Cards */}
					<div className="block sm:hidden space-y-1.5">
						{/* Logo and Company Info */}
						<motion.div 
							className="text-center bg-white/5 backdrop-blur-sm rounded-lg p-2 border border-white/10"
							variants={cardVariants}
						>
							<motion.div 
							...
							>
								<img
									...
									className="w-4 h-4"
								/>
								<span className="text-sm font-bold ml-1">Bay Valley Tech</span>
							</motion.div>
							<p className="text-white/80 text-[10px] leading-tight">
								Empowering careers, enriching communities through free tech education.
							</p>
						</motion.div>
						...
						<motion.div 
							...
							variants={cardVariants}
						>
							<h4 className="text-[10px] font-semibold mb-1.5 text-white/90 flex items-center justify-center gap-1">
							...
							<div className="flex justify-center gap-2">
								{[
									...
									<motion.a
										...
										target="_blank"
										rel="noopener noreferrer"
										className="text-white/80 hover:text-white text-[9px] font-medium transition-colors duration-200 flex items-center gap-0.5"
										initial={{ opacity: 0, y: 10 }}
										animate={{ opacity: 1, y: 0 }}
						...
						>
							...
							<motion.div className="space-y-0.5">
								<motion.a 
									...
									className="block text-white/80 hover:text-white text-[9px] font-medium transition-colors duration-200"
									whileHover={{ scale: 1.02 }}
								>
									info@bayvalleytech.com
								</motion.a>
								<p className="text-white/70 text-[9px]">Join our Discord for quick help!</p>
							</motion.div>
						</motion.div>
					...
					<motion.div 
						className="hidden sm:grid grid-cols-1 md:grid-cols-3 gap-4 mb-2"
						variants={containerVariants}
						initial="hidden"
						animate="visible"
					>
						...
						>
							<motion.div 
								className="flex justify-center md:justify-start items-center mb-2 pt-1"
								whileHover={{ scale: 1.05 }}
							>
								<img
									src="/images/BVT Logo.png"
						...
						<motion.div 
							...
							variants={cardVariants}
						>
							<h4 className="text-xs font-semibold mb-2 text-blue-200 flex items-center justify-center gap-1.5 pt-1">
						...
						<motion.div 
							className="text-center md:text-right pt-1"
							variants={cardVariants}
						>
							<h4 className="text-xs font-semibold mb-2 text-blue-200 flex items-center justify-center md:justify-end gap-1.5">
							...
							<motion.div className="space-y-0.5">
								...
								<p className="text-gray-300 text-xs">Join our Discord for quick help!</p>
							</motion.div>
						</motion.div>
					</motion.div>
